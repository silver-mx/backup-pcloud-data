...
* The original package name 'dns.backup.backup-pcloud-data' is invalid and this project uses 'dns.backup.backuppclouddata' instead.
...
```
$ docker run --rm backup-pcloud-data:0.0.1-SNAPSHOT
```
